...
let ProductsService = class ProductsService {
    ...
    async search(searchProductDto) {
        oo_alm(`2075210597_155_15_155_49_1`, searchProductDto);
        let criterio = oo_al('', `2075210597_156_19_156_21_1`);
        if ((oo_al(searchProductDto.Filter, `2075210597_157_8_157_31_1`), searchProductDto.Filter)) {
            oo_al(criterio = `&search=${searchProductDto.Filter}`, `2075210597_158_6_158_53_1`);
        }
        if (oo_al(searchProductDto.Categories.length > 0, `2075210597_160_8_160_46_1`)) {
            ...
            }), `2075210597_161_23_165_8_1`);
            if ((oo_al(category, `2075210597_166_10_166_18_1`), category)) {
                oo_al(criterio += `&category=${category.id}`, `2075210597_167_8_167_46_1`);
            }
        }
        if (oo_al(searchProductDto.Brands.length > 0, `2075210597_170_8_170_42_1`)) {
            const brand = oo_al(await this.findBrands().then((brands) => {
                return brands.brands.find((brand) => brand.name === searchProductDto.Brands[0]);
            }), `2075210597_171_20_175_8_1`);
            if ((oo_al(brand, `2075210597_176_10_176_15_1`), brand)) {
                oo_al(criterio += `&tag=${brand.id}`, `2075210597_177_8_177_38_1`);
            }
        }
        console.log(...oo_oo(`2075210597_180_4_180_25_4`, criterio));
        const data = oo_al(await (0, rxjs_1.firstValueFrom)(oo_al(this.httpService
            .get(oo_al(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=${process.env.MUET_WC_CONSUMER_SECRET}&status=publish&per_page=${process.env.WC_PER_PAGE}${criterio}`, `2075210597_184_10_184_227_1`), oo_al({
            headers: oo_al({
                Accept: (oo_al('application/json', `2075210597_187_22_187_40_1`), 'application/json'),
            }, `2075210597_186_21_188_13_1`),
        }, `2075210597_185_10_189_11_1`)), `2075210597_182_6_190_9_1`)
            .pipe((0, operators_1.map)((response) => response.data))), `2075210597_181_17_192_5_1`);
        const finalProducts = oo_al([], `2075210597_193_26_193_28_1`);
        const products = oo_al(Promise.all(oo_al(data.map(async (product) => {
            ...
            if (product.variations.length > 0) {
                ...
                Promise.all(await data.map(oo_al(async (variation) => {
                    oo_alm(`2075210597_213_34_213_48_1`, variation);
                    console.log(...oo_oo(`2075210597_214_14_214_36_4`, variation));
                    const attributes = oo_al(variation.attributes.map((attribute) => {
                        return `${attribute.name}: ${attribute.option}`;
                    }), `2075210597_215_33_217_16_1`);
                    const variationLink = (oo_al(variation._links.self[0].href, `2075210597_218_36_218_65_1`), variation._links.self[0].href);
                    const variationFromAPI = oo_al(await (0, rxjs_1.firstValueFrom)(oo_al(this.httpService
                        .get(oo_al(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products/${variation.id}?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=${process.env.MUET_WC_CONSUMER_SECRET}`, `2075210597_222_20_222_191_1`), oo_al({
                        headers: oo_al({
                            Accept: (oo_al('application/json', `2075210597_225_32_225_50_1`), 'application/json'),
                        }, `2075210597_224_31_226_23_1`),
                    }, `2075210597_223_20_227_21_1`)), `2075210597_220_16_228_19_1`)
                        .pipe((0, operators_1.map)((response) => response.data))), `2075210597_219_39_230_15_1`);
                    let currentValue = oo_al(+variation.price, `2075210597_231_33_231_49_1`);
                    if ((oo_al(variationFromAPI.sale_price, `2075210597_233_18_233_45_1`), variationFromAPI.sale_price)) {
                        oo_al(currentValue = +variationFromAPI.sale_price, `2075210597_234_16_234_59_1`);
                    }
                    else {
                        const htmlPrice = (oo_al(variationFromAPI.price_html, `2075210597_236_34_236_61_1`), variationFromAPI.price_html);
                        console.log(...oo_oo(`2075210597_237_16_237_38_4`, htmlPrice));
                        if ((oo_al(htmlPrice, `2075210597_238_20_238_29_1`), htmlPrice)) {
                            const htmlPriceArray = oo_al(htmlPrice.split('<del>'), `2075210597_239_41_239_65_1`);
                            if (oo_al(htmlPriceArray.length > 1, `2075210597_241_22_241_47_1`)) {
                                const price = oo_al(htmlPriceArray[1].split('</span>'), `2075210597_242_34_242_68_1`);
                                oo_al(currentValue = +price[price.length - 2].replace((oo_al(/[^0-9.-]+/g, `2075210597_244_22_244_34_1`), /[^0-9.-]+/g), (oo_al('', `2075210597_245_22_245_24_1`), '')), `2075210597_243_20_246_21_1`);
                                oo_al(currentValue = currentValue * 1000, `2075210597_247_20_247_54_1`);
                            }
                        }
                    }
                    const exportData = oo_al({
                        name: oo_al(`${product.name} | ${attributes.join(' | ')}`, `2075210597_252_22_252_67_1`),
                        description: oo_al(`${product.short_description.replace((oo_al(/<[^>]+>/g, `2075210597_254_18_254_28_1`), /<[^>]+>/g), (oo_al('', `2075210597_255_18_255_20_1`), ''))}\n${attributes.join('\n')}`, `2075210597_253_29_256_45_1`),
                        originalValue: oo_al(+variation.price, `2075210597_257_31_257_47_1`),
                        currentValue: (oo_al(currentValue, `2075210597_258_30_258_42_1`), currentValue),
                        unitType: (oo_al('Unidad', `2075210597_261_26_261_34_1`), 'Unidad'),
                        unitQuantity: (oo_al(variation.stock_quantity, `2075210597_262_30_262_54_1`), variation.stock_quantity),
                        extras: (oo_al(null, `2075210597_263_24_263_28_1`), null),
                        images: oo_al([
                            oo_al({
                                imageUrl: (oo_al(variation.image.src, `2075210597_266_30_266_49_1`), variation.image.src),
                                order: (oo_al(variation.image.id, `2075210597_267_27_267_45_1`), variation.image.id),
                            }, `2075210597_265_18_268_19_1`),
                        ], `2075210597_264_24_269_17_1`),
                        sku: (oo_al(variation.id, `2075210597_270_21_270_33_1`), variation.id),
                    }, `2075210597_251_33_271_15_1`);
                    if ((oo_al(variation.stock_status === 'instock', `2075210597_272_18_272_54_1`), variation.stock_status === 'instock')) {
                        oo_al(finalProducts.push(exportData), `2075210597_273_16_273_46_1`);
                    }
                }, `2075210597_213_27_275_13_1`)));
            }
            else {
            ...
            return null;
        }), `2075210597_195_6_316_8_1`)), `2075210597_194_21_317_5_1`);
        if (oo_al((await products).length > 0, `2075210597_319_8_319_35_1`)) {
            return oo_al({
                products: oo_al(finalProducts.sort((a, b) => a.name.localeCompare(b.name)), `2075210597_321_18_321_76_1`),
            }, `2075210597_320_6_322_8_1`);
        }
    }
    async findAll() {
        const data = await (0, rxjs_1.firstValueFrom)(this.httpService
