...
let ProductsService = class ProductsService {
    ...
    async fetchProductVariations(productId) {
        oo_alm(`3032424067_154_31_154_40_1`, productId);
        try {
            const response = oo_al(await (0, rxjs_1.firstValueFrom)(oo_al(this.httpService
                .get(oo_al(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products/${productId}/variations?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=${process.env.MUET_WC_CONSUMER_SECRET}&status=publish&per_page=${process.env.WC_PER_PAGE}`, `3032424067_159_12_159_242_1`)), `3032424067_157_8_160_11_1`)
                .pipe((0, operators_1.map)((response) => response.data))), `3032424067_156_23_162_7_1`);
            return oo_al(response, `3032424067_163_6_163_22_1`);
        }
        catch (error) {
            oo_al(error, `3032424067_164_13_164_18_1`);
            console.error('Error fetching product variations:', error);
            return oo_al(null, `3032424067_166_6_166_18_1`);
        }
    }
    async processProduct(product, parentProduct) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        oo_alm(`3032424067_170_23_170_30_1`, product, parentProduct);
        let name = oo_al(product.name, `3032424067_171_15_171_27_1`);
        let description = oo_al((_a = product.short_description) === null || _a === void 0 ? void 0 : _a.replace(/<[^>]+>/g, ''), `3032424067_172_22_172_72_1`);
        let havePrice = oo_al(false, `3032424067_173_20_173_25_1`);
        let category = oo_al(((_b = product.categories) === null || _b === void 0 ? void 0 : _b.length) > 0
            ? oo_al((_c = product.categories[0]) === null || _c === void 0 ? void 0 : _c.name, `3032424067_176_10_176_37_1`)
            : oo_al('Sin Categoria', `3032424067_177_10_177_25_1`), `3032424067_175_6_177_25_1`);
        let images = oo_al((_d = product.images) === null || _d === void 0 ? void 0 : _d.map((image) => ({
            imageUrl: image.src,
            order: image.id,
        })), `3032424067_179_17_182_7_1`);
        try {
            let currentValue = oo_al(+product.price, `3032424067_184_25_184_39_1`);
            if ((oo_al(product.sale_price, `3032424067_185_10_185_28_1`), product.sale_price)) {
                oo_al(currentValue = +product.sale_price, `3032424067_186_8_186_42_1`);
                oo_al(havePrice = true, `3032424067_187_8_187_24_1`);
            }
            else {
                const htmlPrice = (oo_al(product.price_html, `3032424067_189_26_189_44_1`), product.price_html);
                if ((oo_al(htmlPrice, `3032424067_190_12_190_21_1`), htmlPrice)) {
                    const htmlPriceArray = oo_al(htmlPrice.split('<del>'), `3032424067_191_33_191_57_1`);
                    if (oo_al(htmlPriceArray.length > 1, `3032424067_192_14_192_39_1`)) {
                        const price = oo_al(htmlPriceArray[1].split('</span>'), `3032424067_193_26_193_60_1`);
                        oo_al(currentValue = +((_e = price[price.length - 2]) === null || _e === void 0 ? void 0 : _e.replace(/[^0-9.-]+/g, '')), `3032424067_194_12_194_78_1`);
                        oo_al(currentValue *= 1000, `3032424067_195_12_195_32_1`);
                        oo_al(havePrice = true, `3032424067_196_12_196_28_1`);
                    }
                }
            }
            if ((oo_al(parentProduct, `3032424067_201_10_201_23_1`), parentProduct)) {
                const attributes = oo_al(product.attributes.map((attribute) => {
                    return `${attribute.name}: ${attribute.option}`;
                }), `3032424067_202_27_204_10_1`);
                oo_al(name = `${parentProduct.name} | ${attributes.join(' | ')}`, `3032424067_205_8_205_66_1`);
                oo_al(description = `${parentProduct.short_description.replace((oo_al(/<[^>]+>/g, `3032424067_207_10_207_20_1`), /<[^>]+>/g), (oo_al('', `3032424067_208_10_208_12_1`), ''))}\n${attributes.join('\n')} `, `3032424067_206_8_209_38_1`);
                oo_al(category = ((_f = parentProduct.categories[0]) === null || _f === void 0 ? void 0 : _f.name) || 'Sin Categoria', `3032424067_210_8_210_71_1`);
                oo_al(images = [
                    oo_al({
                        imageUrl: (oo_al(product.image.src, `3032424067_213_22_213_39_1`), product.image.src),
                        order: (oo_al(product.image.id, `3032424067_214_19_214_35_1`), product.image.id),
                    }, `3032424067_212_10_215_11_1`),
                ], `3032424067_211_8_216_9_1`);
                if ((oo_al(!havePrice, `3032424067_217_12_217_22_1`), !havePrice)) {
                    if ((oo_al(parentProduct.sale_price, `3032424067_218_14_218_38_1`), parentProduct.sale_price)) {
                        oo_al(currentValue = +parentProduct.sale_price, `3032424067_219_12_219_52_1`);
                        oo_al(havePrice = true, `3032424067_220_12_220_28_1`);
                    }
                    else {
                        const htmlPrice = (oo_al(parentProduct.price_html, `3032424067_222_30_222_54_1`), parentProduct.price_html);
                        if ((oo_al(htmlPrice, `3032424067_223_16_223_25_1`), htmlPrice)) {
                            const htmlPriceArray = oo_al(htmlPrice.split('<del>'), `3032424067_224_37_224_61_1`);
                            if (oo_al(htmlPriceArray.length > 1, `3032424067_225_18_225_43_1`)) {
                                const price = oo_al(htmlPriceArray[1].split('</span>'), `3032424067_226_30_226_64_1`);
                                oo_al(currentValue = +((_g = price[price.length - 2]) === null || _g === void 0 ? void 0 : _g.replace((oo_al(/[^0-9.-]+/g, `3032424067_228_18_228_30_1`), /[^0-9.-]+/g), (oo_al('', `3032424067_229_18_229_20_1`), ''))), `3032424067_227_16_230_17_1`);
                                oo_al(currentValue *= 1000, `3032424067_231_16_231_36_1`);
                                oo_al(havePrice = true, `3032424067_232_16_232_32_1`);
                            }
                        }
                    }
                }
            }
            const exportData = oo_al({
                name: (oo_al(name, `3032424067_240_14_240_18_1`), name),
                description: (oo_al(description, `3032424067_241_21_241_32_1`), description),
                originalValue: oo_al(+product.price, `3032424067_242_23_242_37_1`),
                currentValue,
                category: (oo_al(category, `3032424067_244_18_244_26_1`), category),
                brand: oo_al(((_h = product.tags) === null || _h === void 0 ? void 0 : _h.length) > 0 ? product.tags[0].name : '', `3032424067_245_15_245_67_1`),
                unitType: (oo_al('Unidad', `3032424067_246_18_246_26_1`), 'Unidad'),
                unitQuantity: (oo_al(product.stock_quantity || 1, `3032424067_247_22_247_49_1`), product.stock_quantity || 1),
                extras: (oo_al(null, `3032424067_248_16_248_20_1`), null),
                images: (oo_al(images, `3032424067_249_16_249_22_1`), images),
                sku: (oo_al(product.id, `3032424067_250_13_250_23_1`), product.id),
            }, `3032424067_239_25_251_7_1`);
            if ((oo_al(product.stock_status === 'instock', `3032424067_253_10_253_44_1`), product.stock_status === 'instock')) {
                return oo_al(exportData, `3032424067_254_8_254_26_1`);
            }
        }
        catch (error) {
            oo_al(error, `3032424067_256_13_256_18_1`);
            console.error('Error processing product:', error);
            return oo_al(null, `3032424067_258_6_258_18_1`);
        }
    }
    async search(searchProductDto) {
        oo_alm(`3032424067_262_15_262_49_1`, searchProductDto);
        let criterio = oo_al('&stock_status=instock', `3032424067_263_19_263_42_1`);
        if ((oo_al(searchProductDto.Filter, `3032424067_264_8_264_31_1`), searchProductDto.Filter)) {
            oo_al(criterio += `&search=${searchProductDto.Filter}`, `3032424067_265_6_265_54_1`);
        }
        if (oo_al(searchProductDto.Categories.length > 0, `3032424067_267_8_267_46_1`)) {
            ...
            }), `3032424067_268_23_272_8_1`);
            if ((oo_al(category, `3032424067_273_10_273_18_1`), category)) {
                oo_al(criterio += `&category=${category.id}`, `3032424067_274_8_274_46_1`);
            }
        }
        if (oo_al(searchProductDto.Brands.length > 0, `3032424067_277_8_277_42_1`)) {
            const brand = oo_al(await this.findBrands().then((brands) => {
                return brands.brands.find((brand) => brand.name === searchProductDto.Brands[0]);
            }), `3032424067_278_20_282_8_1`);
            if ((oo_al(brand, `3032424067_283_10_283_15_1`), brand)) {
                oo_al(criterio += `&tag=${brand.id}`, `3032424067_284_8_284_38_1`);
            }
        }
        console.log(...oo_oo(`3032424067_287_4_287_25_4`, criterio));
        try {
            const data = oo_al(await (0, rxjs_1.firstValueFrom)(oo_al(this.httpService
                .get(oo_al(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=${process.env.MUET_WC_CONSUMER_SECRET}${criterio}`, `3032424067_292_12_292_178_1`), oo_al({
                headers: oo_al({
                    Accept: (oo_al('application/json', `3032424067_295_24_295_42_1`), 'application/json'),
                }, `3032424067_294_23_296_15_1`),
            }, `3032424067_293_12_297_13_1`)), `3032424067_290_8_298_11_1`)
                .pipe((0, operators_1.map)((response) => response.data))), `3032424067_289_19_300_7_1`);
            const finalProducts = oo_al([], `3032424067_436_28_436_30_1`);
            for (const product of oo_al(data, `3032424067_437_28_437_32_1`)) {
                if (oo_al(product.variations.length > 0, `3032424067_438_12_438_41_1`)) {
                    const variations = oo_al(await this.fetchProductVariations(product.id), `3032424067_439_29_439_74_1`);
                    for (const variation of (oo_al(variations, `3032424067_440_34_440_44_1`), variations)) {
                        const processedVariation = oo_al(await this.processProduct((oo_al(variation, `3032424067_442_14_442_23_1`), variation), (oo_al(product, `3032424067_443_14_443_21_1`), product)), `3032424067_441_39_444_13_1`);
                        if ((oo_al(processedVariation, `3032424067_445_16_445_34_1`), processedVariation)) {
                            oo_al(finalProducts.push(processedVariation), `3032424067_446_14_446_52_1`);
                        }
                    }
                }
                else {
                    const processedProduct = oo_al(await this.processProduct(product, null), `3032424067_450_35_450_75_1`);
                    if ((oo_al(processedProduct, `3032424067_451_14_451_30_1`), processedProduct)) {
                        oo_al(finalProducts.push(processedProduct), `3032424067_452_12_452_48_1`);
                    }
                }
            }
            return oo_al({
                products: oo_al(finalProducts.sort((a, b) => a.name.localeCompare(b.name)), `3032424067_458_18_458_76_1`),
            }, `3032424067_457_6_459_8_1`);
        }
        catch (error) {
            oo_al(error, `3032424067_460_13_460_18_1`);
            oo_al(common_1.Logger.error(error.message, 'ProductsService.search'), `3032424067_462_6_462_59_1`);
            return oo_al({ status: 'error', message: error.message }, `3032424067_463_6_463_57_1`);
        }
    }
    async findAll() {
        const data = await (0, rxjs_1.firstValueFrom)(this.httpService
            .get(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=${process.env.MUET_WC_CONSUMER_SECRET}&status=publish&per_page=30&stock_status=instock`, {
            headers: {
        ...
        for (const product of data) {
            if (product.variations.length > 0) {
                ...
                for (const variation of variations) {
                    const processedVariation = await this.processProduct(variation, product);
...
;
oo_te;
function oo_al(v, i) { try {
    oo_cm().autoLog(v, i);
}
catch (e) { } return v; }
;
oo_al;
function oo_alm(i, ...v) { try {
    oo_cm().autoLogMany(i, v);
}
catch (e) { } return v; }
;
oo_alm;
function oo_ats(v, i, l) { try {
    oo_cm().autoTime(v, i, l);
}
catch (e) { } return v; }
;
oo_ats;
function oo_ate(v, i, l) { try {
    oo_cm().autoTimeEnd(v, i, l);
}
catch (e) { } return v; }
;
oo_ate;
function oo_atr(v, i) { try {
    oo_cm().autoTrace(v, i);
}
catch (e) { } return v; }
;
oo_atr;
function oo_atrm(i, ...v) { try {
    oo_cm().autoTraceMany(i, v);
}
catch (e) { } return v; }
;
oo_atrm;
function oo_cv(v) { try {
    oo_cm().coverage(v);
}
catch (e) { } }
;
