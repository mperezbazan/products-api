...
let ProductsService = class ProductsService {
    ...
    async fetchProductVariations(productId) {
        oo_alm(`3879776259_154_31_154_40_1`, productId);
        try {
            const response = oo_al(await (0, rxjs_1.firstValueFrom)(oo_al(this.httpService
                .get(oo_al(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products/${productId}/variations?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=${process.env.MUET_WC_CONSUMER_SECRET}&status=publish&per_page=${process.env.WC_PER_PAGE}`, `3879776259_159_12_159_242_1`)), `3879776259_157_8_160_11_1`)
                .pipe((0, operators_1.map)((response) => response.data))), `3879776259_156_23_162_7_1`);
            return oo_al(response, `3879776259_163_6_163_22_1`);
        }
        catch (error) {
            oo_al(error, `3879776259_164_13_164_18_1`);
            console.error('Error fetching product variations:', error);
            return oo_al(null, `3879776259_166_6_166_18_1`);
        }
    }
    async processProduct(product) {
        var _a, _b;
        oo_alm(`3879776259_170_23_170_30_1`, product);
        try {
            let currentValue = oo_al(+product.price, `3879776259_172_25_172_39_1`);
            if ((oo_al(product.sale_price, `3879776259_173_10_173_28_1`), product.sale_price)) {
                oo_al(currentValue = +product.sale_price, `3879776259_174_8_174_42_1`);
            }
            else {
                const htmlPrice = (oo_al(product.price_html, `3879776259_176_26_176_44_1`), product.price_html);
                if ((oo_al(htmlPrice, `3879776259_177_12_177_21_1`), htmlPrice)) {
                    const htmlPriceArray = oo_al(htmlPrice.split('<del>'), `3879776259_178_33_178_57_1`);
                    if (oo_al(htmlPriceArray.length > 1, `3879776259_179_14_179_39_1`)) {
                        console.log(...oo_oo(`3879776259_180_12_180_39_4`, htmlPriceArray));
                        const price = oo_al(htmlPriceArray[1].split('</span>'), `3879776259_181_26_181_60_1`);
                        console.log(...oo_oo(`3879776259_182_12_182_30_4`, price));
                        oo_al(currentValue = +price[price.length - 2].replace(/[^0-9.-]+/g, ''), `3879776259_183_12_183_77_1`);
                        oo_al(currentValue *= 1000, `3879776259_184_12_184_32_1`);
                    }
                }
            }
            const exportData = oo_al({
                name: (oo_al(product.name, `3879776259_190_14_190_26_1`), product.name),
                description: oo_al(product.short_description.replace(/<[^>]+>/g, ''), `3879776259_191_21_191_70_1`),
                originalValue: oo_al(+product.price, `3879776259_192_23_192_37_1`),
                currentValue,
                category: ((_a = product.categories[0]) === null || _a === void 0 ? void 0 : _a.name) || 'Sin Categoria',
                brand: oo_al(((_b = product.tags) === null || _b === void 0 ? void 0 : _b.length) > 0 ? product.tags[0].name : '', `3879776259_195_15_195_67_1`),
                unitType: (oo_al('Unidad', `3879776259_196_18_196_26_1`), 'Unidad'),
                unitQuantity: (oo_al(product.stock_quantity || 1, `3879776259_197_22_197_49_1`), product.stock_quantity || 1),
                extras: (oo_al(null, `3879776259_198_16_198_20_1`), null),
                images: oo_al(product.images.map((image) => ({
                    imageUrl: image.src,
                    order: image.id,
                })), `3879776259_199_16_202_11_1`),
                sku: (oo_al(product.id, `3879776259_203_13_203_23_1`), product.id),
            }, `3879776259_189_25_204_7_1`);
            if ((oo_al(product.stock_status === 'instock', `3879776259_206_10_206_44_1`), product.stock_status === 'instock')) {
                return oo_al(exportData, `3879776259_207_8_207_26_1`);
            }
        }
        catch (error) {
            oo_al(error, `3879776259_209_13_209_18_1`);
            console.error('Error processing product:', error);
            return oo_al(null, `3879776259_211_6_211_18_1`);
        }
    }
    async search(searchProductDto) {
        oo_alm(`3879776259_215_15_215_49_1`, searchProductDto);
        let criterio = oo_al('', `3879776259_216_19_216_21_1`);
        if ((oo_al(searchProductDto.Filter, `3879776259_217_8_217_31_1`), searchProductDto.Filter)) {
            oo_al(criterio = `&search=${searchProductDto.Filter}`, `3879776259_218_6_218_53_1`);
        }
        if (oo_al(searchProductDto.Categories.length > 0, `3879776259_220_8_220_46_1`)) {
            ...
            }), `3879776259_221_23_225_8_1`);
            if ((oo_al(category, `3879776259_226_10_226_18_1`), category)) {
                oo_al(criterio += `&category=${category.id}`, `3879776259_227_8_227_46_1`);
            }
        }
        if (oo_al(searchProductDto.Brands.length > 0, `3879776259_230_8_230_42_1`)) {
            const brand = oo_al(await this.findBrands().then((brands) => {
                return brands.brands.find((brand) => brand.name === searchProductDto.Brands[0]);
            }), `3879776259_231_20_235_8_1`);
            if ((oo_al(brand, `3879776259_236_10_236_15_1`), brand)) {
                oo_al(criterio += `&tag=${brand.id}`, `3879776259_237_8_237_38_1`);
            }
        }
        console.log(...oo_oo(`3879776259_240_4_240_25_4`, criterio));
        try {
            const data = oo_al(await (0, rxjs_1.firstValueFrom)(oo_al(this.httpService
                .get(oo_al(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=30${criterio}`, `3879776259_245_12_245_142_1`), oo_al({
                headers: oo_al({
                    Accept: (oo_al('application/json', `3879776259_248_24_248_42_1`), 'application/json'),
                }, `3879776259_247_23_249_15_1`),
            }, `3879776259_246_12_250_13_1`)), `3879776259_243_8_251_11_1`)
                .pipe((0, operators_1.map)((response) => response.data))), `3879776259_242_19_253_7_1`);
            const finalProducts = oo_al([], `3879776259_389_28_389_30_1`);
            for (const product of oo_al(data, `3879776259_390_28_390_32_1`)) {
                if (oo_al(product.variations.length > 0, `3879776259_391_12_391_41_1`)) {
                    const variations = oo_al(await this.fetchProductVariations(product.id), `3879776259_392_29_392_74_1`);
                    for (const variation of (oo_al(variations, `3879776259_393_34_393_44_1`), variations)) {
                        const processedVariation = oo_al(await this.processProduct(variation), `3879776259_394_39_394_75_1`);
                        if ((oo_al(processedVariation, `3879776259_395_16_395_34_1`), processedVariation)) {
                            oo_al(finalProducts.push(processedVariation), `3879776259_396_14_396_52_1`);
                        }
                    }
                }
                else {
                    const processedProduct = oo_al(await this.processProduct(product), `3879776259_400_35_400_69_1`);
                    if ((oo_al(processedProduct, `3879776259_401_14_401_30_1`), processedProduct)) {
                        oo_al(finalProducts.push(processedProduct), `3879776259_402_12_402_48_1`);
                    }
                }
            }
            return oo_al({
                products: oo_al(finalProducts.sort((a, b) => a.name.localeCompare(b.name)), `3879776259_408_18_408_76_1`),
            }, `3879776259_407_6_409_8_1`);
        }
        catch (error) {
            oo_al(error, `3879776259_410_13_410_18_1`);
            oo_al(common_1.Logger.error(error.message, 'ProductsService.search'), `3879776259_412_6_412_59_1`);
            return oo_al({ status: 'error', message: error.message }, `3879776259_413_6_413_57_1`);
        }
    }
    async findAll() {
