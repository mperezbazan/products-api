...
let ProductsService = class ProductsService {
    ...
    async search(searchProductDto) {
        oo_alm(`1008125719_155_15_155_49_1`, searchProductDto);
        let criterio = oo_al('', `1008125719_156_19_156_21_1`);
        if ((oo_al(searchProductDto.Filter, `1008125719_157_8_157_31_1`), searchProductDto.Filter)) {
            oo_al(criterio = `&search=${searchProductDto.Filter}`, `1008125719_158_6_158_53_1`);
        }
        if (oo_al(searchProductDto.Categories.length > 0, `1008125719_160_8_160_46_1`)) {
            ...
            }), `1008125719_161_23_165_8_1`);
            if ((oo_al(category, `1008125719_166_10_166_18_1`), category)) {
                oo_al(criterio += `&category=${category.id}`, `1008125719_167_8_167_46_1`);
            }
        }
        if (oo_al(searchProductDto.Brands.length > 0, `1008125719_170_8_170_42_1`)) {
            const brand = oo_al(await this.findBrands().then((brands) => {
                return brands.brands.find((brand) => brand.name === searchProductDto.Brands[0]);
            }), `1008125719_171_20_175_8_1`);
            if ((oo_al(brand, `1008125719_176_10_176_15_1`), brand)) {
                oo_al(criterio += `&tag=${brand.id}`, `1008125719_177_8_177_38_1`);
            }
        }
        console.log(...oo_oo(`1008125719_180_4_180_25_4`, criterio));
        const data = oo_al(await (0, rxjs_1.firstValueFrom)(oo_al(this.httpService
            .get(oo_al(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=${process.env.MUET_WC_CONSUMER_SECRET}&status=publish&per_page=${process.env.WC_PER_PAGE}${criterio}`, `1008125719_184_10_184_227_1`), oo_al({
            headers: oo_al({
                Accept: (oo_al('application/json', `1008125719_187_22_187_40_1`), 'application/json'),
            }, `1008125719_186_21_188_13_1`),
        }, `1008125719_185_10_189_11_1`)), `1008125719_182_6_190_9_1`)
            .pipe((0, operators_1.map)((response) => response.data))), `1008125719_181_17_192_5_1`);
        const finalProducts = oo_al([], `1008125719_193_26_193_28_1`);
        const products = oo_al(Promise.all(oo_al(data.map(async (product) => {
            ...
            if (product.variations.length > 0) {
                ...
                Promise.all(data.map(oo_al((variation) => {
                    oo_alm(`1008125719_213_22_213_36_1`, variation);
                    const attributes = oo_al(variation.attributes.map((attribute) => {
                        return `${attribute.name}: ${attribute.option}`;
                    }), `1008125719_214_33_216_16_1`);
                    let currentValue = oo_al(+variation.price, `1008125719_217_33_217_49_1`);
                    if ((oo_al(variation.sale_price, `1008125719_219_18_219_38_1`), variation.sale_price)) {
                        oo_al(currentValue = +variation.sale_price, `1008125719_220_16_220_52_1`);
                    }
                    else {
                        const htmlPrice = (oo_al(variation.price_html, `1008125719_222_34_222_54_1`), variation.price_html);
                        if ((oo_al(htmlPrice, `1008125719_223_20_223_29_1`), htmlPrice)) {
                            const htmlPriceArray = oo_al(htmlPrice.split('<del>'), `1008125719_224_41_224_65_1`);
                            if (oo_al(htmlPriceArray.length > 1, `1008125719_226_22_226_47_1`)) {
                                const price = oo_al(htmlPriceArray[1].split('</span>'), `1008125719_227_34_227_68_1`);
                                oo_al(currentValue = +price[price.length - 2].replace((oo_al(/[^0-9.-]+/g, `1008125719_229_22_229_34_1`), /[^0-9.-]+/g), (oo_al('', `1008125719_230_22_230_24_1`), '')), `1008125719_228_20_231_21_1`);
                                oo_al(currentValue = currentValue * 1000, `1008125719_232_20_232_54_1`);
                            }
                        }
                    }
                    console.log(...oo_oo(`1008125719_236_14_236_56_4`, variation.price, currentValue));
                    const exportData = oo_al({
                        name: oo_al(`${product.name} | ${attributes.join(' | ')}`, `1008125719_238_22_238_67_1`),
                        description: oo_al(`${product.short_description.replace((oo_al(/<[^>]+>/g, `1008125719_240_18_240_28_1`), /<[^>]+>/g), (oo_al('', `1008125719_241_18_241_20_1`), ''))}\n${attributes.join('\n')}`, `1008125719_239_29_242_45_1`),
                        originalValue: oo_al(+variation.price, `1008125719_243_31_243_47_1`),
                        currentValue: (oo_al(currentValue, `1008125719_244_30_244_42_1`), currentValue),
                        unitType: (oo_al('Unidad', `1008125719_247_26_247_34_1`), 'Unidad'),
                        unitQuantity: (oo_al(variation.stock_quantity, `1008125719_248_30_248_54_1`), variation.stock_quantity),
                        extras: (oo_al(null, `1008125719_249_24_249_28_1`), null),
                        images: oo_al([
                            oo_al({
                                imageUrl: (oo_al(variation.image.src, `1008125719_252_30_252_49_1`), variation.image.src),
                                order: (oo_al(variation.image.id, `1008125719_253_27_253_45_1`), variation.image.id),
                            }, `1008125719_251_18_254_19_1`),
                        ], `1008125719_250_24_255_17_1`),
                        sku: (oo_al(variation.id, `1008125719_256_21_256_33_1`), variation.id),
                    }, `1008125719_237_33_257_15_1`);
                    if ((oo_al(variation.stock_status === 'instock', `1008125719_258_18_258_54_1`), variation.stock_status === 'instock')) {
                        oo_al(finalProducts.push(exportData), `1008125719_259_16_259_46_1`);
                    }
                }, `1008125719_213_21_261_13_1`)));
            }
            else {
            ...
            return null;
        }), `1008125719_195_6_302_8_1`)), `1008125719_194_21_303_5_1`);
        if (oo_al((await products).length > 0, `1008125719_305_8_305_35_1`)) {
            return oo_al({
                products: oo_al(finalProducts.sort((a, b) => a.name.localeCompare(b.name)), `1008125719_307_18_307_76_1`),
            }, `1008125719_306_6_308_8_1`);
        }
    }
    async findAll() {
        const data = await (0, rxjs_1.firstValueFrom)(this.httpService
