...
let ProductsService = class ProductsService {
    ...
    async search(searchProductDto) {
        oo_alm(`3745716285_155_15_155_49_1`, searchProductDto);
        let criterio = oo_al('', `3745716285_156_19_156_21_1`);
        if ((oo_al(searchProductDto.Filter, `3745716285_157_8_157_31_1`), searchProductDto.Filter)) {
            oo_al(criterio = `&search=${searchProductDto.Filter}`, `3745716285_158_6_158_53_1`);
        }
        if (oo_al(searchProductDto.Categories.length > 0, `3745716285_160_8_160_46_1`)) {
            ...
            }), `3745716285_161_23_165_8_1`);
            if ((oo_al(category, `3745716285_166_10_166_18_1`), category)) {
                oo_al(criterio += `&category=${category.id}`, `3745716285_167_8_167_46_1`);
            }
        }
        if (oo_al(searchProductDto.Brands.length > 0, `3745716285_170_8_170_42_1`)) {
            const brand = oo_al(await this.findBrands().then((brands) => {
                return brands.brands.find((brand) => brand.name === searchProductDto.Brands[0]);
            }), `3745716285_171_20_175_8_1`);
            if ((oo_al(brand, `3745716285_176_10_176_15_1`), brand)) {
                oo_al(criterio += `&tag=${brand.id}`, `3745716285_177_8_177_38_1`);
            }
        }
        console.log(...oo_oo(`3745716285_180_4_180_25_4`, criterio));
        const data = oo_al(await (0, rxjs_1.firstValueFrom)(oo_al(this.httpService
            .get(oo_al(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=${process.env.MUET_WC_CONSUMER_SECRET}&status=publish&per_page=${process.env.WC_PER_PAGE}${criterio}`, `3745716285_184_10_184_227_1`), oo_al({
            headers: oo_al({
                Accept: (oo_al('application/json', `3745716285_187_22_187_40_1`), 'application/json'),
            }, `3745716285_186_21_188_13_1`),
        }, `3745716285_185_10_189_11_1`)), `3745716285_182_6_190_9_1`)
            .pipe((0, operators_1.map)((response) => response.data))), `3745716285_181_17_192_5_1`);
        const finalProducts = oo_al([], `3745716285_193_26_193_28_1`);
        const products = oo_al(Promise.all(oo_al(data.map(async (product) => {
            ...
            return null;
        }), `3745716285_195_6_267_8_1`)), `3745716285_194_21_268_5_1`);
        if (oo_al((await products).length > 0, `3745716285_270_8_270_35_1`)) {
            return oo_al({
                products: oo_al(finalProducts.sort((a, b) => a.name.localeCompare(b.name)), `3745716285_272_18_272_76_1`),
            }, `3745716285_271_6_273_8_1`);
        }
    }
    async findAll() {
        const data = await (0, rxjs_1.firstValueFrom)(this.httpService
