...
let ProductsService = class ProductsService {
    ...
    async fetchProductVariations(productId) {
        oo_alm(`2985936017_154_31_154_40_1`, productId);
        try {
            const response = oo_al(await (0, rxjs_1.firstValueFrom)(oo_al(this.httpService
                .get(oo_al(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products/${productId}/variations?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=${process.env.MUET_WC_CONSUMER_SECRET}&status=publish&per_page=${process.env.WC_PER_PAGE}`, `2985936017_159_12_159_242_1`)), `2985936017_157_8_160_11_1`)
                .pipe((0, operators_1.map)((response) => response.data))), `2985936017_156_23_162_7_1`);
            return oo_al(response, `2985936017_163_6_163_22_1`);
        }
        catch (error) {
            oo_al(error, `2985936017_164_13_164_18_1`);
            console.error('Error fetching product variations:', error);
            return oo_al(null, `2985936017_166_6_166_18_1`);
        }
    }
    async processProduct(product, parentProduct) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        oo_alm(`2985936017_170_23_170_30_1`, product, parentProduct);
        let name = oo_al(product.name, `2985936017_171_15_171_27_1`);
        let description = oo_al((_a = product.short_description) === null || _a === void 0 ? void 0 : _a.replace(/<[^>]+>/g, ''), `2985936017_172_22_172_72_1`);
        let havePrice = oo_al(false, `2985936017_173_20_173_25_1`);
        let category = oo_al(((_b = product.categories) === null || _b === void 0 ? void 0 : _b.length) > 0
            ? oo_al((_c = product.categories[0]) === null || _c === void 0 ? void 0 : _c.name, `2985936017_176_10_176_37_1`)
            : oo_al('Sin Categoria', `2985936017_177_10_177_25_1`), `2985936017_175_6_177_25_1`);
        try {
            let currentValue = oo_al(+product.price, `2985936017_179_25_179_39_1`);
            if ((oo_al(product.sale_price, `2985936017_180_10_180_28_1`), product.sale_price)) {
                oo_al(currentValue = +product.sale_price, `2985936017_181_8_181_42_1`);
                oo_al(havePrice = true, `2985936017_182_8_182_24_1`);
            }
            else {
                const htmlPrice = (oo_al(product.price_html, `2985936017_184_26_184_44_1`), product.price_html);
                if ((oo_al(htmlPrice, `2985936017_185_12_185_21_1`), htmlPrice)) {
                    const htmlPriceArray = oo_al(htmlPrice.split('<del>'), `2985936017_186_33_186_57_1`);
                    if (oo_al(htmlPriceArray.length > 1, `2985936017_187_14_187_39_1`)) {
                        const price = oo_al(htmlPriceArray[1].split('</span>'), `2985936017_188_26_188_60_1`);
                        oo_al(currentValue = +((_d = price[price.length - 2]) === null || _d === void 0 ? void 0 : _d.replace(/[^0-9.-]+/g, '')), `2985936017_189_12_189_78_1`);
                        oo_al(currentValue *= 1000, `2985936017_190_12_190_32_1`);
                        oo_al(havePrice = true, `2985936017_191_12_191_28_1`);
                    }
                }
            }
            if ((oo_al(parentProduct, `2985936017_196_10_196_23_1`), parentProduct)) {
                const attributes = oo_al(product.attributes.map((attribute) => {
                    return `${attribute.name}: ${attribute.option}`;
                }), `2985936017_197_27_199_10_1`);
                oo_al(name = `${parentProduct.name} | ${attributes.join(' | ')}`, `2985936017_200_8_200_66_1`);
                oo_al(description = `${parentProduct.short_description.replace((oo_al(/<[^>]+>/g, `2985936017_202_10_202_20_1`), /<[^>]+>/g), (oo_al('', `2985936017_203_10_203_12_1`), ''))}\n${attributes.join('\n')} `, `2985936017_201_8_204_38_1`);
                oo_al(category = ((_e = parentProduct.categories[0]) === null || _e === void 0 ? void 0 : _e.name) || 'Sin Categoria', `2985936017_205_8_205_71_1`);
                if ((oo_al(!havePrice, `2985936017_206_12_206_22_1`), !havePrice)) {
                    if ((oo_al(parentProduct.sale_price, `2985936017_207_14_207_38_1`), parentProduct.sale_price)) {
                        oo_al(currentValue = +parentProduct.sale_price, `2985936017_208_12_208_52_1`);
                        oo_al(havePrice = true, `2985936017_209_12_209_28_1`);
                    }
                    else {
                        const htmlPrice = (oo_al(parentProduct.price_html, `2985936017_211_30_211_54_1`), parentProduct.price_html);
                        if ((oo_al(htmlPrice, `2985936017_212_16_212_25_1`), htmlPrice)) {
                            const htmlPriceArray = oo_al(htmlPrice.split('<del>'), `2985936017_213_37_213_61_1`);
                            if (oo_al(htmlPriceArray.length > 1, `2985936017_214_18_214_43_1`)) {
                                const price = oo_al(htmlPriceArray[1].split('</span>'), `2985936017_215_30_215_64_1`);
                                oo_al(currentValue = +((_f = price[price.length - 2]) === null || _f === void 0 ? void 0 : _f.replace((oo_al(/[^0-9.-]+/g, `2985936017_217_18_217_30_1`), /[^0-9.-]+/g), (oo_al('', `2985936017_218_18_218_20_1`), ''))), `2985936017_216_16_219_17_1`);
                                oo_al(currentValue *= 1000, `2985936017_220_16_220_36_1`);
                                oo_al(havePrice = true, `2985936017_221_16_221_32_1`);
                            }
                        }
                    }
                }
            ...
            const exportData = oo_al({
                name: (oo_al(name, `2985936017_229_14_229_18_1`), name),
                description: (oo_al(description, `2985936017_230_21_230_32_1`), description),
                originalValue: oo_al(+product.price, `2985936017_231_23_231_37_1`),
                currentValue,
                category: (oo_al(category, `2985936017_233_18_233_26_1`), category),
                brand: oo_al(((_g = product.tags) === null || _g === void 0 ? void 0 : _g.length) > 0 ? product.tags[0].name : '', `2985936017_234_15_234_67_1`),
                unitType: (oo_al('Unidad', `2985936017_235_18_235_26_1`), 'Unidad'),
                unitQuantity: (oo_al(product.stock_quantity || 1, `2985936017_236_22_236_49_1`), product.stock_quantity || 1),
                extras: (oo_al(null, `2985936017_237_16_237_20_1`), null),
                images: oo_al((_h = product.images) === null || _h === void 0 ? void 0 : _h.map((image) => ({
                    imageUrl: image.src,
                    order: image.id,
                })), `2985936017_238_16_241_11_1`),
                sku: (oo_al(product.id, `2985936017_242_13_242_23_1`), product.id),
            }, `2985936017_228_25_243_7_1`);
            if ((oo_al(product.stock_status === 'instock', `2985936017_245_10_245_44_1`), product.stock_status === 'instock')) {
                return oo_al(exportData, `2985936017_246_8_246_26_1`);
            }
        }
        catch (error) {
            oo_al(error, `2985936017_248_13_248_18_1`);
            console.error('Error processing product:', error);
            return oo_al(null, `2985936017_250_6_250_18_1`);
        }
    }
    async search(searchProductDto) {
        oo_alm(`2985936017_254_15_254_49_1`, searchProductDto);
        let criterio = oo_al('&stock_status=instock', `2985936017_255_19_255_42_1`);
        if ((oo_al(searchProductDto.Filter, `2985936017_256_8_256_31_1`), searchProductDto.Filter)) {
            oo_al(criterio += `&search=${searchProductDto.Filter}`, `2985936017_257_6_257_54_1`);
        }
        if (oo_al(searchProductDto.Categories.length > 0, `2985936017_259_8_259_46_1`)) {
            ...
            }), `2985936017_260_23_264_8_1`);
            if ((oo_al(category, `2985936017_265_10_265_18_1`), category)) {
                oo_al(criterio += `&category=${category.id}`, `2985936017_266_8_266_46_1`);
            }
        }
        if (oo_al(searchProductDto.Brands.length > 0, `2985936017_269_8_269_42_1`)) {
            const brand = oo_al(await this.findBrands().then((brands) => {
                return brands.brands.find((brand) => brand.name === searchProductDto.Brands[0]);
            }), `2985936017_270_20_274_8_1`);
            if ((oo_al(brand, `2985936017_275_10_275_15_1`), brand)) {
                oo_al(criterio += `&tag=${brand.id}`, `2985936017_276_8_276_38_1`);
            }
        }
        console.log(...oo_oo(`2985936017_279_4_279_25_4`, criterio));
        try {
            const data = oo_al(await (0, rxjs_1.firstValueFrom)(oo_al(this.httpService
                .get(oo_al(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=${process.env.MUET_WC_CONSUMER_SECRET}${criterio}`, `2985936017_284_12_284_178_1`), oo_al({
                headers: oo_al({
                    Accept: (oo_al('application/json', `2985936017_287_24_287_42_1`), 'application/json'),
                }, `2985936017_286_23_288_15_1`),
            }, `2985936017_285_12_289_13_1`)), `2985936017_282_8_290_11_1`)
                .pipe((0, operators_1.map)((response) => response.data))), `2985936017_281_19_292_7_1`);
            const finalProducts = oo_al([], `2985936017_428_28_428_30_1`);
            for (const product of oo_al(data, `2985936017_429_28_429_32_1`)) {
                if (oo_al(product.variations.length > 0, `2985936017_430_12_430_41_1`)) {
                    const variations = oo_al(await this.fetchProductVariations(product.id), `2985936017_431_29_431_74_1`);
                    for (const variation of (oo_al(variations, `2985936017_432_34_432_44_1`), variations)) {
                        const processedVariation = oo_al(await this.processProduct((oo_al(variation, `2985936017_434_14_434_23_1`), variation), (oo_al(product, `2985936017_435_14_435_21_1`), product)), `2985936017_433_39_436_13_1`);
                        if ((oo_al(processedVariation, `2985936017_437_16_437_34_1`), processedVariation)) {
                            oo_al(finalProducts.push(processedVariation), `2985936017_438_14_438_52_1`);
                        }
                    }
                }
                else {
                    const processedProduct = oo_al(await this.processProduct(product, null), `2985936017_442_35_442_75_1`);
                    if ((oo_al(processedProduct, `2985936017_443_14_443_30_1`), processedProduct)) {
                        oo_al(finalProducts.push(processedProduct), `2985936017_444_12_444_48_1`);
                    }
                }
            }
            return oo_al({
                products: oo_al(finalProducts.sort((a, b) => a.name.localeCompare(b.name)), `2985936017_450_18_450_76_1`),
            }, `2985936017_449_6_451_8_1`);
        }
        catch (error) {
            oo_al(error, `2985936017_452_13_452_18_1`);
            oo_al(common_1.Logger.error(error.message, 'ProductsService.search'), `2985936017_454_6_454_59_1`);
            return oo_al({ status: 'error', message: error.message }, `2985936017_455_6_455_57_1`);
        }
    }
    async findAll() {
