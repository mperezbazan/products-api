...
let ProductsService = class ProductsService {
    ...
    async fetchProductVariations(productId) {
        oo_alm(`3501620685_154_31_154_40_1`, productId);
        try {
            const response = oo_al(await (0, rxjs_1.firstValueFrom)(oo_al(this.httpService
                .get(oo_al(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products/${productId}/variations?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=${process.env.MUET_WC_CONSUMER_SECRET}&status=publish&per_page=${process.env.WC_PER_PAGE}`, `3501620685_159_12_159_242_1`)), `3501620685_157_8_160_11_1`)
                .pipe((0, operators_1.map)((response) => response.data))), `3501620685_156_23_162_7_1`);
            return oo_al(response, `3501620685_163_6_163_22_1`);
        }
        catch (error) {
            oo_al(error, `3501620685_164_13_164_18_1`);
            console.error('Error fetching product variations:', error);
            return oo_al(null, `3501620685_166_6_166_18_1`);
        }
    }
    async processProduct(product) {
        var _a, _b;
        oo_alm(`3501620685_170_23_170_30_1`, product);
        try {
            let currentValue = oo_al(+product.price, `3501620685_172_25_172_39_1`);
            if ((oo_al(product.sale_price, `3501620685_173_10_173_28_1`), product.sale_price)) {
                oo_al(currentValue = +product.sale_price, `3501620685_174_8_174_42_1`);
            }
            else {
                const htmlPrice = (oo_al(product.price_html, `3501620685_176_26_176_44_1`), product.price_html);
                if ((oo_al(htmlPrice, `3501620685_177_12_177_21_1`), htmlPrice)) {
                    const htmlPriceArray = oo_al(htmlPrice.split('<del>'), `3501620685_178_33_178_57_1`);
                    if (oo_al(htmlPriceArray.length > 1, `3501620685_179_14_179_39_1`)) {
                        const price = oo_al(htmlPriceArray[1].split('</span>'), `3501620685_180_26_180_60_1`);
                        oo_al(currentValue = +price[price.length - 2].replace(/[^0-9.-]+/g, ''), `3501620685_181_12_181_77_1`);
                        oo_al(currentValue *= 1000, `3501620685_182_12_182_32_1`);
                    }
                }
            }
            const exportData = oo_al({
                name: (oo_al(product.name, `3501620685_188_14_188_26_1`), product.name),
                description: oo_al(product.short_description.replace(/<[^>]+>/g, ''), `3501620685_189_21_189_70_1`),
                originalValue: oo_al(+product.price, `3501620685_190_23_190_37_1`),
                currentValue,
                category: ((_a = product.categories[0]) === null || _a === void 0 ? void 0 : _a.name) || 'Sin Categoria',
                brand: oo_al(((_b = product.tags) === null || _b === void 0 ? void 0 : _b.length) > 0 ? product.tags[0].name : '', `3501620685_193_15_193_67_1`),
                unitType: (oo_al('Unidad', `3501620685_194_18_194_26_1`), 'Unidad'),
                unitQuantity: (oo_al(product.stock_quantity || 1, `3501620685_195_22_195_49_1`), product.stock_quantity || 1),
                extras: (oo_al(null, `3501620685_196_16_196_20_1`), null),
                images: oo_al(product.images.map((image) => ({
                    imageUrl: image.src,
                    order: image.id,
                })), `3501620685_197_16_200_11_1`),
                sku: (oo_al(product.id, `3501620685_201_13_201_23_1`), product.id),
            }, `3501620685_187_25_202_7_1`);
            if ((oo_al(product.stock_status === 'instock', `3501620685_204_10_204_44_1`), product.stock_status === 'instock')) {
                return oo_al(exportData, `3501620685_205_8_205_26_1`);
            }
        }
        catch (error) {
            oo_al(error, `3501620685_207_13_207_18_1`);
            console.error('Error processing product:', error);
            return oo_al(null, `3501620685_209_6_209_18_1`);
        }
    }
    async search(searchProductDto) {
        oo_alm(`3501620685_213_15_213_49_1`, searchProductDto);
        let criterio = oo_al('', `3501620685_214_19_214_21_1`);
        if ((oo_al(searchProductDto.Filter, `3501620685_215_8_215_31_1`), searchProductDto.Filter)) {
            oo_al(criterio = `&search=${searchProductDto.Filter}`, `3501620685_216_6_216_53_1`);
        }
        if (oo_al(searchProductDto.Categories.length > 0, `3501620685_218_8_218_46_1`)) {
            ...
            }), `3501620685_219_23_223_8_1`);
            if ((oo_al(category, `3501620685_224_10_224_18_1`), category)) {
                oo_al(criterio += `&category=${category.id}`, `3501620685_225_8_225_46_1`);
            }
        }
        if (oo_al(searchProductDto.Brands.length > 0, `3501620685_228_8_228_42_1`)) {
            const brand = oo_al(await this.findBrands().then((brands) => {
                return brands.brands.find((brand) => brand.name === searchProductDto.Brands[0]);
            }), `3501620685_229_20_233_8_1`);
            if ((oo_al(brand, `3501620685_234_10_234_15_1`), brand)) {
                oo_al(criterio += `&tag=${brand.id}`, `3501620685_235_8_235_38_1`);
            }
        }
        console.log(...oo_oo(`3501620685_238_4_238_25_4`, criterio));
        try {
            const data = oo_al(await (0, rxjs_1.firstValueFrom)(oo_al(this.httpService
                .get(oo_al(`${process.env.MUET_WC_URL}/wp-json/wc/v3/products?consumer_key=${process.env.MUET_WC_CONSUMER_KEY}&consumer_secret=${process.env.MUET_WC_CONSUMER_SECRET}&status=publish&per_page=${process.env.WC_PER_PAGE}${criterio}`, `3501620685_243_12_243_229_1`), oo_al({
                headers: oo_al({
                    Accept: (oo_al('application/json', `3501620685_246_24_246_42_1`), 'application/json'),
                }, `3501620685_245_23_247_15_1`),
            }, `3501620685_244_12_248_13_1`)), `3501620685_241_8_249_11_1`)
                .pipe((0, operators_1.map)((response) => response.data))), `3501620685_240_19_251_7_1`);
            const finalProducts = oo_al([], `3501620685_387_28_387_30_1`);
            for (const product of oo_al(data, `3501620685_388_28_388_32_1`)) {
                if (oo_al(product.variations.length > 0, `3501620685_389_12_389_41_1`)) {
                    const variations = oo_al(await this.fetchProductVariations(product.id), `3501620685_390_29_390_74_1`);
                    for (const variation of (oo_al(variations, `3501620685_391_34_391_44_1`), variations)) {
                        const processedVariation = oo_al(await this.processProduct(variation), `3501620685_392_39_392_75_1`);
                        if ((oo_al(processedVariation, `3501620685_393_16_393_34_1`), processedVariation)) {
                            oo_al(finalProducts.push(processedVariation), `3501620685_394_14_394_52_1`);
                        }
                    }
                }
                else {
                    const processedProduct = oo_al(await this.processProduct(product), `3501620685_398_35_398_69_1`);
                    if ((oo_al(processedProduct, `3501620685_399_14_399_30_1`), processedProduct)) {
                        oo_al(finalProducts.push(processedProduct), `3501620685_400_12_400_48_1`);
                    }
                }
            }
            return oo_al({
                products: oo_al(finalProducts.sort((a, b) => a.name.localeCompare(b.name)), `3501620685_406_18_406_76_1`),
            }, `3501620685_405_6_407_8_1`);
        }
        catch (error) {
            oo_al(error, `3501620685_408_13_408_18_1`);
            oo_al(common_1.Logger.error(error.message, 'ProductsService.search'), `3501620685_410_6_410_59_1`);
            return oo_al({ status: 'error', message: error.message }, `3501620685_411_6_411_57_1`);
        }
    }
    async findAll() {
